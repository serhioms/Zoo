...
public class BusinessTaxJurisdiction implements Serializable, Cloneable
{
    ...
    private final static long serialVersionUID = 1284740092393054036L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public BusinessTaxJurisdiction() {
    }
     ...
     * @param actionCd
     */
    public BusinessTaxJurisdiction(String countryCd, String taxpayerIdentificationNum, String actionCd, String taxpayerIdentificationNumNotProvidedInd) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BusinessTaxJurisdiction) == false) {
            return false;
        }
        BusinessTaxJurisdiction rhs = ((BusinessTaxJurisdiction) other);
