...
public class AmountFeature {
     ...
     */
    @JsonProperty("fromCcyamt")
    public FromCcyamt getFromCcyamt() {
        return fromCcyamt;
    }
     ...
     */
    @JsonProperty("fromCcyamt")
    public void setFromCcyamt(FromCcyamt fromCcyamt) {
     ...
     */
    @JsonProperty("toCcyamt")
    public void setToCcyamt(ToCcyamt toCcyamt) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AmountFeature) == false) {
            return false;
        }
        AmountFeature rhs = ((AmountFeature) other);
