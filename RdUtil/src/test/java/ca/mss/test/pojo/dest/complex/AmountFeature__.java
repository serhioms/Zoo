...
public class AmountFeature__ {
    ...
    @Valid
    private FromCcyamt__ fromCcyamt;
    /**
     ...
     */
    @JsonProperty("fromCcyamt")
    public FromCcyamt__ getFromCcyamt() {
        return fromCcyamt;
    }
     ...
     */
    @JsonProperty("fromCcyamt")
    public void setFromCcyamt(FromCcyamt__ fromCcyamt) {
     ...
     */
    @JsonProperty("toCcyamt")
    public void setToCcyamt(ToCcyamt__ toCcyamt) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AmountFeature__) == false) {
            return false;
        }
        AmountFeature__ rhs = ((AmountFeature__) other);
