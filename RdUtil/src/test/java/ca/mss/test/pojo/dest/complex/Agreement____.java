...
public class Agreement____ {
    ...
    @Valid
    private List<AgreementToFeature____> agreementToFeature = new ArrayList<AgreementToFeature____>();
     ...
     */
    @JsonProperty("altkey")
    public void setAltkey(Altkey____ altkey) {
        this.altkey = altkey;
    }
     ...
     */
    @JsonProperty("agreementToFeature")
    public List<AgreementToFeature____> getAgreementToFeature() {
     ...
     */
    @JsonProperty("agreementToFeature")
    public void setAgreementToFeature(List<AgreementToFeature____> agreementToFeature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Agreement____) == false) {
            return false;
        }
        Agreement____ rhs = ((Agreement____) other);
