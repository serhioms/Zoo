...
public class MetaData {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("applicationId", applicationId).append("subApplicationList", subApplicationList).append("lobName", lobName).append("channel", channel).append("originatingChannelCd", originatingChannelCd).append("sourceCd", sourceCd).append("flowId", flowId).append("clientIp", clientIp).append("isSsoAuthenticated", isSsoAuthenticated).append("agentId", agentId).append("connectId", connectId).append("sessionId", sessionId).append("stage", stage).append("uniqueMessageId", uniqueMessageId).append("testSet", testSet).append("testSystem", testSystem).append("daPartyId", daPartyId).append("additionalProperties", additionalProperties).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(agentId).append(testSystem).append(originatingChannelCd).append(testSet).append(daPartyId).append(channel).append(uniqueMessageId).append(sourceCd).append(sessionId).append(isSsoAuthenticated).append(stage).append(subApplicationList).append(clientIp).append(additionalProperties).append(applicationId).append(connectId).append(flowId).append(lobName).toHashCode();
    }
