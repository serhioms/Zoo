...
public class AgreementToFeature_ {
     ...
     */
    @JsonProperty("feature")
    public void setFeature(Feature_ feature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgreementToFeature_) == false) {
            return false;
        }
        AgreementToFeature_ rhs = ((AgreementToFeature_) other);
