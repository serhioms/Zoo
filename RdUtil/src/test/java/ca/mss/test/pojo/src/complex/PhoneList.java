...
public class PhoneList implements Serializable, Cloneable
{
    ...
    private final static long serialVersionUID = 4892275802220060369L;
     ...
     * @param type
     */
    public PhoneList(String number, String areaCode, String type, String countryCd, Boolean isPrimary, String extension, Boolean isSecondary, String corelationId, String actionInd) {
        super();
        this.number = number;
