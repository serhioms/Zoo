...
public class RelatedAgreementEvent_ {
     ...
     */
    @JsonProperty("agreement")
    public Agreement__ getAgreement() {
        return agreement;
    }
     ...
     */
    @JsonProperty("agreement")
    public void setAgreement(Agreement__ agreement) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedAgreementEvent_) == false) {
            return false;
        }
        RelatedAgreementEvent_ rhs = ((RelatedAgreementEvent_) other);
