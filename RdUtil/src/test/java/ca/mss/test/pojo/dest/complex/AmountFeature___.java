...
public class AmountFeature___ {
    ...
    @Valid
    private FromCcyamt___ fromCcyamt;
    /**
     ...
     */
    @JsonProperty("fromCcyamt")
    public FromCcyamt___ getFromCcyamt() {
        return fromCcyamt;
    }
     ...
     */
    @JsonProperty("fromCcyamt")
    public void setFromCcyamt(FromCcyamt___ fromCcyamt) {
     ...
     */
    @JsonProperty("toCcyamt")
    public ToCcyamt___ getToCcyamt() {
        return toCcyamt;
    }
     ...
     */
    @JsonProperty("toCcyamt")
    public void setToCcyamt(ToCcyamt___ toCcyamt) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AmountFeature___) == false) {
            return false;
        }
        AmountFeature___ rhs = ((AmountFeature___) other);
