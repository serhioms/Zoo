...
public class AmountFeature_ {
    ...
    @Valid
    private FromCcyamt_ fromCcyamt;
    /**
     ...
     */
    @JsonProperty("fromCcyamt")
    public FromCcyamt_ getFromCcyamt() {
        return fromCcyamt;
    }
     ...
     */
    @JsonProperty("fromCcyamt")
    public void setFromCcyamt(FromCcyamt_ fromCcyamt) {
     ...
     */
    @JsonProperty("toCcyamt")
    public void setToCcyamt(ToCcyamt_ toCcyamt) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AmountFeature_) == false) {
            return false;
        }
        AmountFeature_ rhs = ((AmountFeature_) other);
