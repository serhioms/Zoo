...
public class AgreementToFeature____ {
     ...
     */
    @JsonProperty("feature")
    public void setFeature(Feature____ feature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgreementToFeature____) == false) {
            return false;
        }
        AgreementToFeature____ rhs = ((AgreementToFeature____) other);
