...
public class Cccyamt_ {
    ...
    /**
     * ISO 4217 Currency Code, for example, CAD, USD.
     * 
     */
    @JsonProperty("currencyCd")
    @JsonPropertyDescription("ISO 4217 Currency Code, for example, CAD, USD.")
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cccyamt_) == false) {
            return false;
        }
        Cccyamt_ rhs = ((Cccyamt_) other);
