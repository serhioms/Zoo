...
public class AgreementToFeature__ {
     ...
     */
    @JsonProperty("feature")
    public void setFeature(Feature__ feature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgreementToFeature__) == false) {
            return false;
        }
        AgreementToFeature__ rhs = ((AgreementToFeature__) other);
