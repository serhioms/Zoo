...
public class Agreement {
    ...
    @Valid
    private List<AgreementToFeature> agreementToFeature = new ArrayList<AgreementToFeature>();
     ...
     */
    @JsonProperty("agreementToFeature")
    public List<AgreementToFeature> getAgreementToFeature() {
     ...
     */
    @JsonProperty("agreementToFeature")
    public void setAgreementToFeature(List<AgreementToFeature> agreementToFeature) {
