...
public class Agreement___ {
    ...
    @Valid
    private List<AgreementToParty__> agreementToParty = new ArrayList<AgreementToParty__>();
    /**
    ...
    @Valid
    private List<AgreementToFeature___> agreementToFeature = new ArrayList<AgreementToFeature___>();
     ...
     */
    @JsonProperty("altkey")
    public void setAltkey(Altkey___ altkey) {
        this.altkey = altkey;
    }
     ...
     */
    @JsonProperty("agreementToParty")
    public List<AgreementToParty__> getAgreementToParty() {
     ...
     */
    @JsonProperty("agreementToParty")
    public void setAgreementToParty(List<AgreementToParty__> agreementToParty) {
     ...
     */
    @JsonProperty("agreementToFeature")
    public List<AgreementToFeature___> getAgreementToFeature() {
     ...
     */
    @JsonProperty("agreementToFeature")
    public void setAgreementToFeature(List<AgreementToFeature___> agreementToFeature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Agreement___) == false) {
            return false;
        }
        Agreement___ rhs = ((Agreement___) other);
