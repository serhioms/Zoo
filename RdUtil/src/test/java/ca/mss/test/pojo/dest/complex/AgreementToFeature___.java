...
public class AgreementToFeature___ {
     ...
     */
    @JsonProperty("feature")
    public void setFeature(Feature___ feature) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AgreementToFeature___) == false) {
            return false;
        }
        AgreementToFeature___ rhs = ((AgreementToFeature___) other);
