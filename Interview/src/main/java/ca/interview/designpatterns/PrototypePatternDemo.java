...
public class PrototypePatternDemo {
	...
	static public abstract class Shape implements Cloneable {
	...
	static public class ShapeCache {
	...
	// Step 4
	// PrototypePatternDemo uses ShapeCache class to get clones of shapes stored
	// in a Hashtable.
