...
public class ChessTest2 {
	...
	public void testBPawnEnPassantMove() {
		history.setPiece(piece=bpawn, BoardLocation.f4);
		history.setPiece(piece=wpawn, BoardLocation.e2);
		// System.out.println( game.getWhiteBoard() );
		history.addMove(piece=wpawn, BoardLocation.e4);
		// System.out.println( game.getWhiteBoard() );
		// System.out.println( "Legal moves for ["+bpawn.toRecord()+"]: "+bpawn.getLegalMoveList(history) );
		history.addMove(piece=bpawn, BoardLocation.e3);
		// System.out.println( game.getWhiteBoard() );
		// System.out.println( "Legal moves for ["+bpawn.toRecord()+"]: "+piece.getLegalMoveList(history) );
		assertTrue("e2".equals(piece.getLegalMoveList(history)));
	}	
	...
	public void testBPawnEnPassantLegal() {
		...
		// System.out.println( game.getWhiteBoard() );
		// System.out.println( "Legal moves for ["+bpawn.toRecord()+"]: "+bpawn.getLegalMoveList(history) );
		assertTrue("f3,e3".equals(bpawn.getLegalMoveList(history)));
	}	

	@Test
	public void testWPawnEnPassantLegal() {
		history.setPiece(piece=wpawn, BoardLocation.f5);
		history.setPiece(piece=bpawn, BoardLocation.e7);
		// System.out.println( game.getWhiteBoard() );
		history.addMove(piece=bpawn, BoardLocation.e5);
		// System.out.println( game.getWhiteBoard() );
		// System.out.println( "Legal moves for ["+wpawn.toRecord()+"]: "+wpawn.getLegalMoveList(history) );
		assertTrue("f6,e6".equals(wpawn.getLegalMoveList(history)));
	}	

	@Test
	public void testBPawnCapture2F() {
		history.setPiece(brook, BoardLocation.d6);
		history.setPiece(wpawn, BoardLocation.f6);
		assertTrue(dotest(bpawn, e7, "e6,e5,f6"));
	}	

	@Test
	public void testBPawnCapture2() {
		history.setPiece(wrook, BoardLocation.d6);
		history.setPiece(wpawn, BoardLocation.f6);
	...
	public void testWPawnCapture2F() {
		history.setPiece(wrook, BoardLocation.d5);
		history.setPiece(bpawn, BoardLocation.f5);
		assertTrue(dotest(wpawn, e4, "e5,f5"));
	}	

	@Test
	public void testWPawnCapture2() {
		history.setPiece(brook, BoardLocation.d5);
		history.setPiece(bpawn, BoardLocation.f5);
	...
	public void testWKingRokirovka() {
		history.setPiece(wrook, BoardLocation.h1);
		assertTrue(dotest(wking, e1, "f2,d2,e2,f1,g1,d1"));
	}	

	@Test
	public void testBKingRokirovka() {
		history.setPiece(brook, BoardLocation.h8);
